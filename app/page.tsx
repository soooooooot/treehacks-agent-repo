      ...
      <div className="relative z-10 flex min-h-screen flex-col items-center justify-center px-6 py-8">
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:gap-6">
          ...
          <button
            onClick={(e) => {
              e.stopPropagation();
              // Gift button action - can be customized as needed
              alert("🎁 Your gift is here! 💝");
            }}
            className="rounded-full bg-[#c45c7a] px-8 py-4 text-white font-medium transition-all hover:bg-[#8b2942] hover:scale-105 active:scale-95 shadow-lg hover:shadow-xl"
            style={{ fontFamily: "var(--font-body)" }}
          >
            See your gift 🎁
          </button>
