  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex min-h-screen flex-col items-center justify-center px-6 py-8">
        <h1
          className="mb-4 text-6xl font-[family-name:var(--font-display)] text-[#ff1493] md:text-8xl"
          style={{ fontFamily: "var(--font-display)" }}
        >
          Random Valentines
        </h1>
        <p className="mb-12 text-center text-xl text-[#ff69b4] md:text-2xl">
      ...
      {popups.map((popup) => (
        ...
        >
          ...
          <p
            className="max-w-[280px] text-center text-xl text-[#ff69b4]"
            style={{ fontFamily: "var(--font-display)" }}
          >
            {popup.message}
          </p>
