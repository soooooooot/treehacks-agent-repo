      ...
      <div className="relative z-10 flex min-h-screen flex-col items-center justify-center px-6 py-8">
        ...
        <div className="flex flex-col sm:flex-row gap-4 items-center">
          ...
          <button
            ...
            className="rounded-full bg-[#c45c7a] px-8 py-4 text-white font-medium transition-all hover:bg-[#f8e8ec] hover:text-[#8b2942] hover:scale-105 active:scale-95 border-2 border-[#c45c7a]"
            style={{ fontFamily: "var(--font-body)" }}
          >
            We love TreeHacks!
          </button>
