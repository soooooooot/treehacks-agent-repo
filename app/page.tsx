  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex min-h-screen flex-col items-center justify-center px-6 py-8">
        <h1
          className="mb-4 text-6xl font-[family-name:var(--font-display)] text-[#8B4513] md:text-8xl"
          style={{ fontFamily: "var(--font-display)" }}
        >
          Random Valentines
        </h1>
        <p className="mb-12 text-center text-xl text-[#A0522D] md:text-2xl">
        ...
        <button
          ...
          className="rounded-full bg-[#8B4513] px-8 py-4 text-white font-medium transition-all hover:bg-[#A0522D] hover:scale-105 active:scale-95"
      ...
      {popups.map((popup) => (
        ...
        >
          <div
            className="animate-pop-in rounded-2xl border-2 border-[#A0522D]/50 bg-[#F5DEB3] p-6 shadow-xl transition-all hover:scale-105 hover:shadow-2xl"
            style={{
          ...
          <button
            ...
            className="absolute -right-2 -top-2 flex h-8 w-8 items-center justify-center rounded-full bg-[#8B4513] text-white text-sm hover:bg-[#A0522D]"
          >
            ×
          </button>
          <p
